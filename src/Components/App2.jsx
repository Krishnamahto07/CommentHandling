...
function App2() {
  return (
    <MDBContainer fluid className="my-5 bg-slate-50 w-[35%] h-[35%] font-semibold px-5 pb-3 hover:scale-95 transition-all duration-200 ease-linear hover:shadow-white shadow-2xl hover:border-black rounded-md">
